...
const FAQCard = ({
  ...
  return (
    <div
      ...
      className="cursor-pointer border-b border-gray-200 px-2 dark:border-gray-700"
    >
      <div className="flex items-center justify-between gap-3 pb-3 ">
        <h1 className="question text-base font-bold duration-300">
          {question}
        </h1>
        <div className="rounded-full bg-gray-200 p-1 duration-300 hover:bg-black hover:text-white dark:bg-primary_color dark:hover:bg-gray-200 dark:hover:text-black">
          <DropDown_icon
